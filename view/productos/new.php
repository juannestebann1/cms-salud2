...
<form method="post">
  <div class="form-row">
    <div class="form-group col-md-12">
      ...
      <input type="text" class="form-control" name="Registro_sanitario" placeholder="2017DM-0000426-R1">
    </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input type="text" class="form-control" name="Forma_farmaceutica" placeholder="NO APLICA">
    </div>
    <div class="form-group col-md-4">
      <label for="inputAddress2">presentacion comercial</label>
      <input type="text" class="form-control" name="presentacion_comercial" placeholder="KIT">
    </div>
    <div class="form-group col-md-4">
      <label for="inputAddress2">concentracion</label>
      <input type="text" class="form-control" name="concentracion" placeholder="NO APLICA">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-3">
      <label for="inputCity">Marca</label>
      <input type="text" class="form-control" name="marca" placeholder="11/05/2027">
    </div>
    <div class="form-group col-md-3">
      <label for="inputCity">Estado registro sanitario</label>
      <input type="text" class="form-control" name="estado_registro_sanitario" placeholder="11/05/2027">
    </div>
    <div class="form-group col-md-3">
      <label for="inputZip">clasificacion de riesgo</label>
      <input type="text" class="form-control" name="clasificacion_riesgo" placeholder="IIa">
    </div>
    <div class="form-group col-md-3">
      <label for="inputZip">vida util</label>
      <input type="text" class="form-control" name="vida_util" placeholder="5 años">
    </div>
  </div>
