...
<ol class="breadcrumb">
  <li><a href="<?php echo $this->BaseUrl('admin/entrada/listar/?tipo=' . $this->Attach['Entrada']->Tipo); ?>"><?php echo $this->Attach['Entrada']->Tipo == 1 ? 'Páginas' : 'Blog'; ?> </a></li>
  <li class="active"><?php echo $this->Attach['Entrada']->id == 0 ? 'Nuevo Registro' : $this->Attach['Entrada']->Nombre; ?></li>
</ol>

<form action="<?php echo $this->BaseUrl('admin/entrada/guardar'); ?>" method="POST">
